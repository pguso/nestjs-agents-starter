...
Short lessons for this NestJS agents starter: how the project is structured, how to add features, how OpenAPI/Swagger fits, and how a React app should talk to the API.
...
Run the app (`npm run start:dev`), then open [http://localhost:3000/docs](http://localhost:3000/docs) while reading lessons 3 and 4.
